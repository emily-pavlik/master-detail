const CSV_PATH = "https://emily-pavlik.github.io/master-detail/iowa-warblers.csv";
...
function renderGrid() {
  ...
  warblers.forEach((bird, index) => {
    ...
    image.src = `https://emily-pavlik.github.io/master-detail/images/thumbnails/${slugify(bird.name)}${BIRD_THUMBNAIL_EXTENSION}`;
    image.alt = "";
    image.loading = "lazy";
    ...
    <ul class="food-list">
      ${foods.map((food) => `
        <li class="food-item">
          <img
            class="food-image"
            src="https://emily-pavlik.github.io/master-detail/images/food/${slugify(food)}${FOOD_IMAGE_EXTENSION}"
            alt=""
            loading="lazy"
            decoding="async"
          >
